...
<header id="navbar" class="flex justify-between items-center text-white p-4">
    ...
    <div class="flex items-center space-x-4">
        ...
        <span class="hidden md:inline-block">Bem-vindo, <?= $_SESSION['nome_usuario'] ?? 'Usuário'; ?></span>
  ...
  <body class="bg-gray-100">
    ...
    <div class="bg-white p-6 rounded shadow-md">
        ...
        <div class="flex justify-between items-center mb-4 flex-wrap">
           ...
           <button id="openPopupAdd" class="open-popup-btn" style="margin-left: 10px; padding: 5px; background-color: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer;" onclick="abrirPopupAdicionar()">
    <i class='bx bxs-plus-circle'></i> Novo Cliente
</button>
...
<!-- Botão de editar -->
<td style="padding: 10px; text-align: center;">
    <button onclick="window.open('popup_cliente.php?id=<?php echo $registro['id']; ?>', '_blank')" class="open-popup-btn">
